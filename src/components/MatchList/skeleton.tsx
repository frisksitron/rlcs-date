      ...
      {[1, 2, 3, 4].map((match, index) => {
        ...
        return (
          ...
          >
            <div
              className={
                "w-6 w-8 w-10 w-12 w-16 w-20 w-24 w-28 w-32 w-36 hidden"
              }
            ></div>
              ...
              <div className="flex items-center">
                ...
                <div className={"pl-2 md:pl-5"}>
                  <div className="lg:hidden overflow-hidden">
                    <div
                      className={`${randomWidths[0][1]} h-6 bg-slate-500 animate-pulse rounded-sm`}
                    ></div>
                  </div>
                  <div className="hidden lg:block">
                    <div
                      className={`${randomWidths[0][0]} h-6 bg-slate-500 animate-pulse rounded-sm`}
                    ></div>
                  </div>
                </div>
              </div>
            ...
            <div className="w-5/12">
              <div className="flex justify-end items-center text-right">
                <div className={"pr-2 md:pr-5"}>
                  <div className="lg:hidden overflow-hidden">
                    <div
                      className={`${randomWidths[1][1]} h-6 bg-slate-500 animate-pulse rounded-sm`}
                    ></div>
                  </div>
                  <div className="hidden lg:block">
                    <div
                      className={`${randomWidths[1][0]} h-6 bg-slate-500 animate-pulse rounded-sm`}
                    ></div>
                  </div>
                </div>
                <div className="avatar">
